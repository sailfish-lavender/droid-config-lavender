# DisplayName: Jolla lavender/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: lavender
# DeviceVariant: lavender
# Brand: Jolla
...
repo --name=adaptation-common-lavender-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-lavender-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-lavender
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/lavender
